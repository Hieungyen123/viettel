                ...
                <div className={cx('flex')}>
                    <div className={cx('content')}>
                        <div className={cx('title')}>
                            <div className={cx('title-h2')} ><h2 data-aos ='fade-down' data-aos-duration = '2000'>TỔNG ĐÀI LẮP ĐẶT INTERNET VIETTEL. Đăng ký lắp mạng wifi cho gia đình bạn.</h2></div>
                            <div className={cx('title-content')} data-aos ='fade-up' data-aos-duration = '2000'>
                        ...
                        <div className={cx('body-content')} >
                            <div className={cx('body-img')}>
                                ...
                                <div className={cx('body-item')}>
                                    <div className={cx('item')}  data-aos ='fade-up-left' data-aos-duration = '4500'>
                                        <SecurityIcon/>
                                ...
                                <img src={img} alt="" data-aos ='zoom-out' data-aos-duration = '2000'/>
                            </div>
                        </div>
                        <div className={cx('last-content')} >
                            <div>
                                ...
                                <div>
                                    <p data-aos ='fade-right' data-aos-duration = '4500'>
                                    ...
                                    <p data-aos ='fade-right' data-aos-duration = '5500'>
                                    ...
                                    <p data-aos ='fade-left' data-aos-duration = '5500'>
                                    ...
                                    <p data-aos ='fade-right' data-aos-duration = '=6500'>
                                    ...
                                    <p data-aos ='fade-left' data-aos-duration = '7500'>
                                    ...
                                    <p data-aos ='fade-right' data-aos-duration = '8500'>
